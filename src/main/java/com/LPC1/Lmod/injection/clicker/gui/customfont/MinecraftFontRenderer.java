package com.LPC1.Lmod.injection.clicker.gui.customfont;
...
public class MinecraftFontRenderer extends CFont {
    private final CFont.CharData[] boldChars = new CFont.CharData[256], italicChars = new CFont.CharData[256], boldItalicChars = new CFont.CharData[256];
    private final int[] colorCode = new int[32];
    private final String colorcodeIdentifiers = "0123456789abcdefklmnor";
    private DynamicTexture texBold, texItalic, texItalicBold;
